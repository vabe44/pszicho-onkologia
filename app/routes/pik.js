...
router.get("/", function(req, res) {
    knex.select('id', 'user_id', 'csoport', 'datum', 'alkalom', 'megjegyzes').from('whoqol_nyersadatok')
    .then(function(rows) {
        res.render("qol/index", {rows:rows});
    })
...
router.get("/:id", function(req, res) {
    knex('pik_nyersadatok').where('id', req.params.id)
    .then(function(rows) {
        res.render("pik/vonas/show", {rows:rows});
    })
    .catch(function(error) {
        console.error(error)
    });
